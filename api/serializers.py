...
from api.models import RecortesDiario, RecortesLinkIgnorado, RecortesMonitoradownloads, RecortesNumeracaoErrada, \
    RecortesRecorte, RecortesRecorteStfStj, RecortesRecorteTjmt
...
class RecortesTribunaisSerializer(ModelSerializer):
    class Meta:
        model = RecortesRecorte
        fields = 'codigo_diario'
